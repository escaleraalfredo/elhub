...
import { ThumbsUp, ThumbsDown, MessageCircle, Smile, Bookmark } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#09090b] pb-20">
      <div className="max-w-md mx-auto px-4 py-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="text-xs bg-zinc-800 px-3 py-1 rounded-full">Comunidad Boricua</div>
        </div>
